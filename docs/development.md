...
- `docs/index.md` is the landing page and should stay short and navigable.
...
- The release job refreshes the lockfile, runs tests, builds distributions, uploads to PyPI, and creates a GitHub release from the same artifacts.
